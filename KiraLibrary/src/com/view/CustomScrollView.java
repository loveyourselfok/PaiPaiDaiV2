...
public class CustomScrollView extends ScrollView {
	...
	public void initView(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(
				MResource.getIdByName(context, "layout", "header"), null);

		arrowImageView = (ImageView) headView.findViewById(MResource
				.getIdByName(context, "id", "head_arrowImageView"));
		arrowImageView.setMinimumWidth(70);
		arrowImageView.setMinimumHeight(50);
		progressBar = (ProgressBar) headView.findViewById(MResource
				.getIdByName(context, "id", "head_progressBar"));
		tipsTextview = (TextView) headView.findViewById(MResource.getIdByName(
				context, "id", "head_tipsTextView"));
		lastUpdatedTextView = (TextView) headView.findViewById(MResource
				.getIdByName(context, "id", "head_lastUpdatedTextView"));
	...
	public void setRefreshTextTextColor(int color) {
	...
	private void changeHeaderViewByState() {
		...
		case DONE:
			...
			progressBar.setVisibility(View.GONE);
			arrowImageView.clearAnimation();
			arrowImageView.setImageResource(MResource.getIdByName(context,
					"drawable", "xlistview_arrow"));
			tipsTextview.setText("下拉刷新");
			lastUpdatedTextView.setVisibility(View.VISIBLE);
			isRecored = false;
			break;
